...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div initial="hidden" viewport={{ once: false, amount: 0.25 }} whileInView="show" variants={staggerContainer} className={`${styles.flexCenter} {styles.innnerWidth} mx-auto flex-col`}>
      ...
      <motion.img variants={fadeIn('up', 'tween', 0.3, 1)} src="/arrow-down.svg" alt="arrow down" className="w-[18px] h-[28px] mt-[28px] object-contain" />
    </motion.div>
  </section>
);
